...
class TestConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) = with(target) {
        ...
        dependencies {
            ...
            add("testImplementation", libs.findLibrary("androidx-paging-common").get())
            add("testImplementation", libs.findLibrary("androidx-paging-testing").get())
            add("testImplementation", libs.findLibrary("androidx-recyclerview").get())
            add("testImplementation", libs.findLibrary("androidx-paging-runtime").get())
        }
    }
}